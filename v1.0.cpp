	...
	while(true){
		...
		if(addR.wasClicked(g/65536, g%65536)){
			...
			while(!done.wasClicked(a/65536, a%65536)){
				...
				double r;
				r=getInput<double>("Enter resistance value and press Enter: ");
				
				string promptstr="Click a point to place the resistor there";
				Text prompt(textWidth(promptstr)/2, 750, promptstr);
		...
		if(addI.wasClicked(g/65536, g%65536)){
			...
			while(!done.wasClicked(a/65536, a%65536)){
				...
				q=whoWasClicked(b/65536, b%65536, nlist);
				double i;
				i=getInput<double>("Enter current value and press Enter: ");
				
				string promptstr="Click a point to place the current source there";
				Text prompt(textWidth(promptstr)/2, 750, promptstr);
		...
		if(addV.wasClicked(g/65536, g%65536)){
			...
			while(!done.wasClicked(a/65536, a%65536)){
				...
				q=whoWasClicked(b/65536, b%65536, nlist);
				double v;
				v=getInput<double>("Enter voltage value and press Enter: ");
				
				string promptstr="Click a point to place the battery there";
				Text prompt(textWidth(promptstr)/2, 750, promptstr);
